  ...
  return (
    <Dialog>
      ...
      <DialogContent className="sm:max-w-md">
        <DialogHeader>
          <DialogTitle className="text-3xl text-primary-title font-semibold tracking-[0.6px] mb-2">
            Contact us
          </DialogTitle>
          <DialogDescription className="text-primary font-medium tracking-[0.32px]">
        ...
        <div className="flex flex-col gap-3">
          ...
          <div className="flex items-center gap-2">
            <Checkbox id="terms" />
            <label htmlFor="terms" className="text-primary tracking-[0.32px] text-[14px]">
